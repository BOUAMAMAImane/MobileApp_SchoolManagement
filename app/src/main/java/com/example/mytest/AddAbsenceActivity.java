...
public class AddAbsenceActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Obtenez la liste des matières disponibles à partir de votre base de données
        ...
        subjectListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                // Passer l'ID de la matière à l'activité StudentListActivity
                Intent intent = new Intent( AddAbsenceActivity.this, StudentListActivity.class);
